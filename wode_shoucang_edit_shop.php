...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="./css/goods/wode_shoucang_bianji2.css" />
...
<body data-ctrl=true>
	...
	<div class = "container-title" >
		<span style="color:#676767;">共收藏<font class = "font-red">5</font>个店铺</span>
	</div>
    		...
    		<li class = "li-wrapper">
    			<div class = "item-wrapper">
    				...
    				<div class = "item-wrapper-left2">
    					<img class = "item-photo" src = "./images/temp/g_temp/2016042701.png" width="100" height = "100"/>
    				</div>
...
<script src="./js/goods/wode_shoucang_bianji2.js"></script>
</body>
</html>